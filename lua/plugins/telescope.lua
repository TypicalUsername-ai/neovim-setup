return { "nvim-telescope/telescope.nvim", -- @01.03.24 Telescope for file swapping
		dependencies = { "nvim-lua/plenary.nvim", -- 01.03.24 plenary for concurrent util for telescope deps
